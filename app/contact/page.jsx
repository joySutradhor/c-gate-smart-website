...
export default function ContactPage() {
  ...
  return (
    <main className="bg-[#F8FAFC] text-[#1F2937]">
      ...
      <section className="border-y border-[#E4E9EE] bg-white">
        ...
        >
          ...
          >
            ...
            <p
              ...
              "
            >
              From the first conversation through to the
              finished project, we focus on creating a
              solution that works for your property.
            </p>
            ...
            {[
              {
                ...
                text: "Solutions created around your property, style and requirements.",
              },

              {
                number: "02",
                title: "Quality Craftsmanship",
                text: "Careful attention to detail from design through to installation.",
              },

              {
                number: "03",
                title: "Expert Guidance",
                text: "Practical advice to help you choose the right solution.",
              },

              {
                number: "04",
                title: "Built to Last",
                text: "Designed with durability, functionality and long-term performance in mind.",
              },
            ].map((item) => (
          ...
          >
            ...
            <div className="max-w-2xl">
              ...
              <p
                ...
                "
              >
                Get in touch with the GateSmart team
                to discuss your gate, automation or
                metalwork requirements.
              </p>
