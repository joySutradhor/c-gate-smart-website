      ...
      <section className="bg-[#F8FAFC]">
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 md:py-16 lg:px-10 lg:py-20">
          ...
          <div className="mb-12 flex items-center justify-center gap-2 text-sm text-[#667085]">
            ...
            <span>Electric Gates High Wycombe</span>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-base leading-8 text-[#667085] md:text-lg">
              As a local gate company serving High Wycombe and the
              surrounding area, Gate Smart provides new gates, automation,
              servicing and fault finding for homes and commercial premises.
              Our bespoke approach is useful where driveways are sloping,
              unusually shaped or used frequently.
            </p>

            <p className="mt-5 text-base leading-8 text-[#667085] md:text-lg">
              We serve customers throughout High Wycombe and nearby areas
              including Hazlemere, Penn, Loudwater, Downley and surrounding
              areas. Contact us to arrange a site visit and discuss the most
