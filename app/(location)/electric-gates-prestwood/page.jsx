...
export default function PrestwoodElectricGatesPage() {
  const [openFaq, setOpenFaq] = useState(null);

  const faqs = [
    {
      question: "Do wooden electric gates require maintenance?",
      answer:
        "Yes. Timber gates need periodic care and protective treatment. During the design stage, we can also explain the relative maintenance needs of timber, metal and aluminium.",
    },
    {
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 md:py-16 lg:px-10 lg:py-20">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-3xl text-base leading-8 text-[#667085] md:text-lg">
              ...
              developments and commercial properties throughout Prestwood and
              the surrounding Chiltern communities.
            </p>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-[-0.02em] text-[#182433] md:text-4xl">
                Bespoke driveway gates in Prestwood
              </h2>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
              <Image
                src={images.driveway}
                alt="Bespoke electric driveway gates installed near Prestwood"
                fill
                className="object-cover"
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <MaterialCard
              image={images.metal}
              title="Metal gates"
              alt="Automated metal gates in Prestwood"
            >
            ...
            <MaterialCard
              image={images.wooden}
              title="Wooden gates"
              alt="Bespoke wooden electric gates in Prestwood"
            >
            ...
            <MaterialCard
              ...
              alt="Modern aluminium electric gates in Prestwood"
            >
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <GateTypeCard
              image={images.swing}
              title="Swing gates"
              alt="Modern automated swing gates in Prestwood"
            >
            ...
            <GateTypeCard
              ...
              title="Sliding gates"
              alt="Modern sliding electric gates in Prestwood"
            >
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="relative order-2 aspect-[4/3] overflow-hidden rounded-3xl lg:order-1">
              <Image
                ...
                alt="Electric gate automation and access control in Prestwood"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl font-semibold tracking-[-0.02em] text-[#182433] md:text-4xl">
                Gate automation and access control in Prestwood
              </h2>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-[-0.02em] text-[#182433] md:text-4xl">
                Electric gate servicing and repairs in Prestwood
              </h2>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
              <Image
                ...
                alt="Gate Smart engineer servicing electric gates in Prestwood"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 md:py-20">
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-semibold tracking-[-0.02em] text-[#182433] md:text-4xl">
              Frequently asked questions about electric gates in Prestwood
            </h2>
          </div>
      ...
      <section className="bg-[#182433] border-b border-white/10">
        <div className="mx-auto max-w-5xl px-5 py-16 text-center sm:px-8 md:py-20">
          ...
          <h2 className="text-3xl font-semibold tracking-[-0.02em] text-white md:text-4xl">
            Request a survey for electric gates in Prestwood
          </h2>
