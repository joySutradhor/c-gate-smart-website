...
export default function Page() {
  ...
  const faqs = [
    {
      question: "Do you maintain high-use electric gates in Ascot?",
      answer:
        "Yes. Service frequency should reflect usage and site conditions. Higher-use entrances normally require more frequent planned maintenance than lightly used domestic gates.",
    },
    {
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 md:py-16 lg:px-10 lg:py-20">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-3xl text-base leading-8 text-[#667085] md:text-lg">
              Bespoke electric gates designed around your property in Ascot,
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-[#182433] md:text-4xl">
                Electric gates designed for your Ascot property
              </h2>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
              <Image
                src={images.driveway}
                alt="Bespoke electric driveway gates installed near Ascot"
                fill
                className="object-cover"
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <MaterialCard
              title="Metal Gates"
              image={images.metal}
              alt="Automated metal gates in Ascot"
            >
            ...
            <MaterialCard
              title="Wooden Gates"
              image={images.wooden}
              alt="Wooden electric driveway gates in Ascot"
            >
            ...
            <MaterialCard
              ...
              alt="Modern aluminium electric gates in Ascot"
            >
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <GateTypeCard
              title="Swing Gates"
              image={images.swing}
              alt="Modern automated swing gates in Ascot"
            >
            ...
            <GateTypeCard
              ...
              alt="Modern sliding electric gates in Ascot"
            >
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
              <Image
                ...
                alt="Electric gate automation and access control in Ascot"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
            ...
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-[#182433] md:text-4xl">
                Gate automation and access control in Ascot
              </h2>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-20 lg:px-10">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-[#182433] md:text-4xl">
                Electric gate servicing and repairs in Ascot
              </h2>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
              <Image
                ...
                alt="Gate Smart engineer servicing electric gates in Ascot"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 md:py-20">
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-[#182433] md:text-4xl">
              Frequently asked questions about electric gates in Ascot
            </h2>
          </div>
      ...
      <section className="bg-[#182433] border-b border-white/10">
        <div className="mx-auto max-w-5xl px-5 py-16 text-center sm:px-8 md:py-20">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white md:text-4xl">
            Request a survey for electric gates in Ascot
          </h2>
